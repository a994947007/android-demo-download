...
import com.luyao.android.demo.download.process.DownloadCallbackProgressInterface;
...
public class DownloadCallbackDispatcher {
    ...
    public void initConnection() {
        Intent intent = new Intent(LuDownload.getInstance().getContext(), DownloadMainProgressService.class);
        LuDownload.getInstance().getContext().bindService(intent, mMainProgressConnection, Context.BIND_AUTO_CREATE);
